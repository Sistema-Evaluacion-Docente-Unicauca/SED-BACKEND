...
public class ActividadDTOEvaluador {
    ...
    public ActividadDTOEvaluador(Integer oidActividad, String codigoActividad, String nombre, String horas, LocalDateTime fechaCreacion, LocalDateTime fechaActualizacion,
