...
public class ActividadDTOEvaluador {
    ...
    public ActividadDTOEvaluador(Integer oidActividad, String codigoActividad, String nombre, Float horas, LocalDateTime fechaCreacion, LocalDateTime fechaActualizacion,
