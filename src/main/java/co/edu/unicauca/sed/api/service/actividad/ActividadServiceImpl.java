...
public class ActividadServiceImpl implements ActividadService {
    ...
    @Autowired
    private ActividadQueryServiceImpl actividadQueryServiceImpl;

    public ApiResponse<Page<ActividadBaseDTO>> findAll(Pageable pageable, Boolean ascendingOrder) {
        boolean order = (ascendingOrder != null) ? ascendingOrder : actividadQueryServiceImpl.DEFAULT_ASCENDING_ORDER;
        ...
        List<ActividadBaseDTO> sortedDTOs = actividadQueryService.ordenarActividadesPorTipo(actividadDTOs, order);
